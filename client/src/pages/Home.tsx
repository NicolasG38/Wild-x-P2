      ...
      <section className="map-pokemon">
        ...
        <figure>
          <Link to={"/Pokemons/1"}>
            <img
              className="regionImg"
              src="/images/regionsMap/KantoG1.png"
              alt="Region Kanto"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/2"}>
            <img
              className="regionImg"
              src="/images/regionsMap/JhotoG2.jpg"
              alt="Region Johto"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/3"}>
            <img
              className="regionImg"
              src="/images/regionsMap/HoennG3.png"
              alt="Region Hoenn"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/4"}>
            <img
              className="regionImg"
              src="/images/regionsMap/SinnohG4.png"
              alt="Region Sinnoh"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/5"}>
            <img
              className="regionImg"
              src="/images/regionsMap/UnysG5.png"
              alt="Region Unys"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/6"}>
            <img
              className="regionImg"
              src="/images/regionsMap/KalosG6.png"
              alt="Region Kalos"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/7"}>
            <img
              className="regionImg"
              src="/images/regionsMap/AlolaG7.png"
              alt="Region Alola"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/8"}>
            <img
              className="regionImg"
              src="/images/regionsMap/GalarG8.png"
              alt="Region Galar"
            />
          </Link>
          <figcaption>
        ...
        <figure>
          <Link to={"/Pokemons/9"}>
            <img
              className="regionImg"
              src="/images/regionsMap/PaldeaG9.png"
              alt="Region Paldea"
            />
          </Link>
          <figcaption>
